...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_MSGEXEC']._serialized_options = b'\x82\xe7\xb0*\x08executor\x8a\xe7\xb0*\x18cosmos-sdk/group/MsgExec'
