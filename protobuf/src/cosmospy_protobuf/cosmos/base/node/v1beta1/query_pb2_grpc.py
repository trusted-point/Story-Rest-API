...
class ServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Status = channel.unary_unary('/cosmos.base.node.v1beta1.Service/Status', request_serializer=cosmos_dot_base_dot_node_dot_v1beta1_dot_query__pb2.StatusRequest.SerializeToString, response_deserializer=cosmos_dot_base_dot_node_dot_v1beta1_dot_query__pb2.StatusResponse.FromString)
...
class Service(object):
    ...
    def Status(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/cosmos.base.node.v1beta1.Service/Status', cosmos_dot_base_dot_node_dot_v1beta1_dot_query__pb2.StatusRequest.SerializeToString, cosmos_dot_base_dot_node_dot_v1beta1_dot_query__pb2.StatusResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)